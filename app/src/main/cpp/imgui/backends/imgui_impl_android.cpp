...
int32_t ImGui_ImplAndroid_HandleInputEvent(AInputEvent* input_event, ImVec2 screen_scale, bool touchFix) {
        ...
        case AINPUT_EVENT_TYPE_MOTION:
        {
            ...
            case AMOTION_EVENT_ACTION_UP:
                ...
                || (AMotionEvent_getToolType(input_event, event_pointer_index) == AMOTION_EVENT_TOOL_TYPE_UNKNOWN))
                {
                    ...
                    ImVec2 finalPos = touchFix ? ImVec2(screen_scale.x > 0 ? pos.x / screen_scale.x : pos.x, screen_scale.y > 0 ? pos.y / screen_scale.y : pos.y)
                        : ImVec2(pos.x, pos.y);
                    io.MousePos = finalPos;
                }
                break;
